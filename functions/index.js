...
exports.transcodeVideo = functions.storage.object().onFinalize(async object => {
    try {
        ...
        const encodedFilePath = encodeURIComponent(targetTranscodedFilePath);
        const downloadURL = `${baseURL}/${bucketName}/o/${encodedFilePath}?alt=media&token=${token}`;
